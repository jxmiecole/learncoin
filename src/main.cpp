...
uint256 hashGenesisBlock("0xdaf238188c3fa22633c4de88041611b5be2024a73159ab20ba2474afb4cc8eb8");
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    // Subsidy is cut in half every 525600 blocks, which will occur approximately every 3 years
    nSubsidy >>= (nHeight / 525600); // Learncoin: 525.6k blocks in ~3 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 3 * 24 * 60 * 60; // Learncoin: 3 days
static const int64 nTargetSpacing = 2 * 60; // Learncoin: 2 minutes
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xb1506a6a9af77a0c44bc3fdba509b4049649b13e909a8d1e293291e461ef2b64");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "09/04/2021 - I am Learn (User Avatar)";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 500 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("043c07df64e7cde6de090a3479b066c12cc7982e14b684f3fed7a5b25b6ccd804640bba9f2bdf9c872295a39dfe9cadacb488b51d322046d20d99c4c8d9d711664") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1620598703;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2084550294;

        if (fTestNet)
        {
            block.nTime    = 1620598669;
            block.nNonce   = 388544349;
        }
...
if (true && block.GetHash() != hashGenesisBlock)
        ...
        assert(block.hashMerkleRoot == uint256("0xcbae83970085504c517ad88fbe8247fa92d19a2b09392f998a30df48559e9a10"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfa, 0xc8, 0xb1, 0xdd }; // Learncoin: increase each by adding 2 to learncoins's value.

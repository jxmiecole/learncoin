...
std::string HelpMessage()
{
    string strUsage = _("Options:") + "\n" +
        ...
        "  -port=<port>           " + _("Listen for connections on <port> (default: 2666 or testnet: 12666)") + "\n" +
        ...
        "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 2668 or testnet: 12668)") + "\n" +
        ...
        "\n" + _("SSL options: (see the Learncoin Wiki for SSL setup instructions)") + "\n" +
